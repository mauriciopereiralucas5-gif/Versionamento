import { F as tryOnScopeDispose, N as toArray, k as notNullish, o as unrefElement, v as useMutationObserver } from "./dist-Dk9C_HFS.mjs";
...
import { computed, onMounted, onUnmounted, readonly, ref, shallowRef, toRef, toValue, useId, watch } from "vue";
...
var useActivatedFocusTrap = ({ element, isActive, noTrap, fallbackFocus, focus }, focusTrapOpts = {
	...
	return { needsFallback: readonly(needsFallback) };
};
//#endregion
...
var useSafeScrollLock = (isOpen, bodyScroll) => {
	...
	*/
	...
	const isLocked = useScrollLock(getSafeDocument()?.body ?? null, resolvedIsOpen.value && inverseBodyScrollingValue.value);
	onMounted(() => {
		...
		watch([resolvedIsOpen, inverseBodyScrollingValue], ([modelVal, bodyVal]) => {
			...
			const scrollBarGap = (getSafeWindow()?.innerWidth ?? 0) - (doc?.documentElement.clientWidth ?? 0);
...
//#endregion
export { useActivatedFocusTrap as n, useSafeScrollLock as t };

//# sourceMappingURL=useSafeScrollLock-Me5LyqjD.mjs.map