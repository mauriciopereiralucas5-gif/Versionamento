import { C as computedEager, D as isClient, E as createSharedComposable, O as isIOS, P as tryOnBeforeUnmount, T as createGlobalState, a as onKeyStroke, f as useEventListener, g as useMounted, n as defaultWindow, o as unrefElement } from "./dist-Dk9C_HFS.mjs";
import { c as createContext, o as injectConfigProviderContext, r as Primitive, s as renderSlotFragments } from "./VisuallyHidden-C4sXnc-k.mjs";
import { n as getActiveElement, t as useForwardExpose } from "./useForwardExpose-Cob6LlGd.mjs";
import { n as defu, r as isNullish } from "./useKbd-DfmgFov6.mjs";
import { a as flip, c as limitShift, d as size, i as autoUpdate, l as offset, n as useFloating, o as hide, t as arrow, u as shift } from "./floating-ui.vue-CH2o_mZU.mjs";
import * as vue from "vue";
import { Teleport, camelize, computed, createBlock, createCommentVNode, createElementBlock, createVNode, defineComponent, getCurrentInstance, h, mergeDefaults, mergeProps, nextTick, normalizeStyle, onMounted, onUnmounted, openBlock, reactive, ref, renderSlot, toHandlerKey, toRef, toRefs, toValue, unref, watch, watchEffect, watchPostEffect, withCtx } from "vue";
...
//#endregion
export { FocusScope_default as a, useId$1 as c, useForwardProps as d, useFocusGuards as f, Teleport_default as i, useHideOthers as l, handleAndDispatchCustomEvent as m, PopperAnchor_default as n, DismissableLayer_default as o, useBodyScrollLock as p, PopperRoot_default as r, Presence_default as s, PopperContent_default as t, useForwardPropsEmits as u };

//# sourceMappingURL=PopperContent-DmSgsjSC.mjs.map