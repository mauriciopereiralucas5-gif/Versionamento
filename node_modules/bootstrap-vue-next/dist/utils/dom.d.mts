...
export declare const getSafeDocument: () => Document | null;
export declare const getSafeWindow: () => (Window & typeof globalThis) | null;
...
export declare const sortSlotElementsByPosition: (a: Readonly<HTMLElement> | null, b: Readonly<HTMLElement> | null) => number;
