...
export type TableFieldFormatterObject<T> = {
    value: unknown;
    key: string;
    item: T;
};
...
export type TableField<T = any> = {
    ...
    thClass?: ClassValue;
    thStyle?: StyleValue;
    tdAttr?: AttrsValue | ((obj: {
        value: unknown;
        key: string;
        item: T;
    }) => AttrsValue);
    thAttr?: AttrsValue | ((obj: {
        value: unknown;
        key: string;
        item: T | null;
        type: TableRowThead;
...
export declare const isTableField: (value: unknown) => value is TableField;
export declare const isTableFieldRaw: (value: unknown) => value is TableFieldRaw;
...
export type MaybeGetter<Obj extends object, Key extends PropertyKey, Output = unknown> = Key | ((obj: Obj) => Output);
