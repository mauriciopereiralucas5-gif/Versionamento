...
import { DateRange, DateValue, SegmentPart, TimeValue } from 'reka-ui';
import { StringAriaInvalid } from './AriaInvalid';
type TimeRange = {
...
export interface BTableSlots<Item> extends Omit<BTableLiteSlots<Item>, 'thead-top' | 'row-expansion' | `head(${string})` | `foot(${string})` | `cell(${string})`> {
    'thead-top'?: (props: {
        columns: number;
        fields: TableField<Item>[];
        selectAllRows: () => void;
