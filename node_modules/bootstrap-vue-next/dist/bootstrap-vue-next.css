...
.b-autocomplete .input-group:has(.b-autocomplete-selection):has(.form-control:focus),
.b-autocomplete .input-group:has(.b-autocomplete-selection):has(.form-control:focus) .b-autocomplete-selection {
  border-color: #86b7fe;
}
...
.b-autocomplete .input-group .b-autocomplete-selection ~ .b-autocomplete-input-wrapper .form-control {
  border-left: 0;
}
...
.b-autocomplete-input-wrapper .form-control {
  flex: 1 1 auto;
  min-width: 0;
  border-radius: inherit;
}

.input-group > .b-autocomplete-input-wrapper:not(:first-child) .form-control {
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
}

.input-group > .b-autocomplete-input-wrapper:first-child .form-control {
  border-top-left-radius: var(--bs-border-radius);
  border-bottom-left-radius: var(--bs-border-radius);
}

.input-group > .b-autocomplete-input-wrapper:not(:last-child) .form-control {
  border-top-right-radius: 0;
  border-bottom-right-radius: 0;
}

.input-group > .b-autocomplete-input-wrapper:last-child .form-control {
  border-top-right-radius: var(--bs-border-radius);
  border-bottom-right-radius: var(--bs-border-radius);
}

.b-autocomplete-clear {
  position: absolute;
  right: 0.5rem;
  top: 50%;
...
.b-autocomplete-clear:hover {
  opacity: 0.75;
}
.b-autocomplete-clear:focus {
  opacity: 1;
}

.b-autocomplete-input-clearable {
...
.b-autocomplete-item[data-highlighted] {
  background-color: var(--bs-dropdown-link-hover-bg);
  color: var(--bs-dropdown-link-hover-color);
}
.b-autocomplete-item[data-state=checked] {
  font-weight: 600;
}
.b-autocomplete-item[data-disabled] {
  opacity: 0.65;
  pointer-events: none;
}
