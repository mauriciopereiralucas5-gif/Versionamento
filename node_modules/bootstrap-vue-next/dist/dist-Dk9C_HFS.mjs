import { computed, customRef, effectScope, getCurrentInstance, getCurrentScope, hasInjectionContext, inject, isRef, nextTick, onBeforeUnmount, onMounted, onScopeDispose, reactive, readonly, ref, shallowReadonly, shallowRef, toRef, toRefs, toValue, unref, watch, watchEffect } from "vue";
...
//#endregion
export { reactiveOmit as A, computedEager as C, isClient as D, createSharedComposable as E, tryOnScopeDispose as F, useIntervalFn as I, useThrottleFn as L, syncRef as M, toArray as N, isIOS as O, tryOnBeforeUnmount as P, useToNumber as R, useVModel as S, createGlobalState as T, useMouse as _, onKeyStroke as a, useSwipe as b, useColorMode as c, useElementHover as d, useEventListener as f, useMounted as g, useIntersectionObserver as h, onClickOutside as i, refAutoReset as j, notNullish as k, useDocumentVisibility as l, useFocus as m, defaultWindow as n, unrefElement as o, useFileDialog as p, getSSRHandler as r, useBreakpoints as s, breakpointsBootstrapV5 as t, useDropZone as u, useMutationObserver as v, createEventHook as w, useTimestamp as x, useScrollLock as y };

//# sourceMappingURL=dist-Dk9C_HFS.mjs.map